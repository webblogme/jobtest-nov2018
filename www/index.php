...
<head>
  ...
  <script src="assets/js/underscroll.js"></script>
...
var Data=[
		...
		"image_url": "https://picsum.photos/200/200?random",
		...
		"image_url": "https://picsum.photos/200/200?random2",
		...
		"image_url": "https://picsum.photos/200/200?random3",
		...
		"image_url": "https://picsum.photos/200/200?random4",
		...
		"image_url": "https://picsum.photos/200/200?random5",
		...
		"image_url": "https://picsum.photos/200/200?random6",
		...
		"image_url": "https://picsum.photos/200/200?random7",
		...
		"image_url": "https://picsum.photos/200/200?random8",
		...
		"image_url": "https://picsum.photos/200/200?random9",
		...
		"image_url": "https://picsum.photos/200/200?random10",
		...
		"image_url": "https://picsum.photos/200/200?random11",
		...
		"image_url": "https://picsum.photos/200/200?random12",
		...
		"image_url": "https://picsum.photos/200/200?random13",
		...
		"image_url": "https://picsum.photos/200/200?random14",
		...
		"image_url": "https://picsum.photos/200/200?random15",
		...
		"image_url": "https://picsum.photos/200/200?random16",
		...
		"image_url": "https://picsum.photos/200/200?random17",
		...
		"image_url": "https://picsum.photos/200/200?random18",
		...
		"image_url": "https://picsum.photos/200/200?random19",
		...
		"image_url": "https://picsum.photos/200/200?random20",
...
<div class="row mb-20 posted">
	<div class="col-xs-10 msg">
		<div class="row">
		<div class="col-xs-3">
			<img class="float-left" src="<%- listPosted.image_url %>">
		</div>
		<div class="col-xs-8">
			<h3><%- listPosted.title %></h3>
			<p><%- listPosted.body %></p>
			<p><span class="glyphicon glyphicon-time" aria-hidden="true"></span> <span data-livestamp="<%- listPosted.created_at %>"></span></p>
		</div>
		</div>
	</div>
	<div class="col-xs-2 user">
	<% var whoPosted = _.where(rc.listItems, {id: listPosted.author_id}) %>
		<img class="img-circle" src="<%- whoPosted[0]['avatar_url'] %>">
		<p><%- whoPosted[0]['name'] %></p>
		<p><%- whoPosted[0]['role'] %></p>
		<p><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> <%- whoPosted[0]['place'] %></p>
	</div>
</div>
<% }); %>
</div>
